...
internal class Utils
{
    ...
    internal static void LogDebug(string message)
    {
        if (_config.DebugEnabled)
            _logger.WriteLine($"[P4 Style Text Boxes] {message}");
    }
    ...
    {
        _logger.WriteLine($"[P4 Style Text Boxes] {message}: {e.Message}", System.Drawing.Color.Red);
    }

    internal static void LogError(string message)
    {
        _logger.WriteLine($"[P4 Style Text Boxes] {message}", System.Drawing.Color.Red);
    }
